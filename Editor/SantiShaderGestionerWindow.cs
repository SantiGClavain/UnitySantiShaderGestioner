...
namespace SantiShaderGestioner.Editor
{
    public sealed class SantiShaderGestionerWindow : EditorWindow
    {
        private const string WindowTitle = "Santi Shader Gestioner";
        ...
        private const string DonePrefsKey = "SantiShaderGestioner.DoneMaterialPaths";
        ...
        [MenuItem("Tools/Santi Shader Gestioner")]
        private static void OpenWindow()
        {
            SantiShaderGestionerWindow window = GetWindow<SantiShaderGestionerWindow>();
